...
class Quadrilateral extends Figure {
    ...
    public double area() {
        double area = 0.25 * Math.sqrt(4.0 * Math.pow(digAC, 2) * Math.pow(digBD, 2) - Math.pow((Math.pow(AB, 2) + Math.pow(CD, 2) - Math.pow(BC, 2) - Math.pow(AD, 2)), 2));
        return area;
    }
    ...
    public boolean isTheSame(Figure figure) {
        ...
        if (    (ax.equals(a2x) || ax.equals(b2x) || ax.equals(c2x) || ax.equals(d2x)) &&
